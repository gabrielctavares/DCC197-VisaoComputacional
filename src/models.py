...
def build_model(model_name, num_classes, device,  use_batch_norm, use_dropout, dropout_rate, freeze_backbone, unfreeze_last_n_params):
    feature_params = None

    model_name = model_name.lower()
    if model_name == "vgg16":
        model = VGG16(num_classes, use_batch_norm, use_dropout, dropout_rate)
...
class VGG16(nn.Module):
    def __init__(self, num_classes=10, use_batch_norm=False, use_dropout=False, dropout_rate=0.5):
